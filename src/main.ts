...
function shell(body: string) {
  ...
  return `<a class="skip" href="#main">Skip to content</a><header><a class="wordmark" href="/" data-route aria-label="Dose Count Compass home"><span aria-hidden="true">◒</span> Dose Count Compass</a><nav aria-label="Main navigation"><a href="/demo" data-route>Demo</a><a href="/log" data-route>My devices</a><a href="/privacy" data-route>Privacy</a></nav></header>${demoBar}<p class="connection" role="status">${connection}</p><main id="main" tabindex="-1">${body}</main><footer><p>Count doses before a device runs out.</p><p><a href="/privacy" data-route>Privacy</a><a href="/terms" data-route>Terms</a><span>Built by Param Factory · v1.2.0</span></p></footer><p class="route-announcer" role="status" aria-live="polite" aria-atomic="true"></p><div class="toast" role="status" aria-live="polite" aria-atomic="true"><span class="toast-message"></span><button class="toast-undo" hidden>Undo</button></div>`;
}
function home() {
